...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.fifoValid );
      signalAccess[1] = new CDataSignalAccess( top.fifoReady );
      signalAccess[2] = new IDataSignalAccess( top.fifoPayload );
      signalAccess[3] = new CDataSignalAccess( top.arValid );
      signalAccess[4] = new CDataSignalAccess( top.arReady );
      signalAccess[5] = new IDataSignalAccess( top.araddr );
      signalAccess[6] = new CDataSignalAccess( top.arid );
      signalAccess[7] = new CDataSignalAccess( top.arregion );
      signalAccess[8] = new CDataSignalAccess( top.arlen );
      signalAccess[9] = new CDataSignalAccess( top.arsize );
      signalAccess[10] = new CDataSignalAccess( top.arburst );
      signalAccess[11] = new CDataSignalAccess( top.arlock );
      signalAccess[12] = new CDataSignalAccess( top.arcache );
      signalAccess[13] = new CDataSignalAccess( top.arqos );
      signalAccess[14] = new CDataSignalAccess( top.arprot );
      signalAccess[15] = new CDataSignalAccess( top.awValid );
      signalAccess[16] = new CDataSignalAccess( top.awReady );
      signalAccess[17] = new IDataSignalAccess( top.awaddr );
      signalAccess[18] = new CDataSignalAccess( top.awid );
      signalAccess[19] = new CDataSignalAccess( top.awregion );
      signalAccess[20] = new CDataSignalAccess( top.awlen );
      signalAccess[21] = new CDataSignalAccess( top.awsize );
      signalAccess[22] = new CDataSignalAccess( top.awburst );
      signalAccess[23] = new CDataSignalAccess( top.awlock );
      signalAccess[24] = new CDataSignalAccess( top.awcache );
      signalAccess[25] = new CDataSignalAccess( top.awqos );
      signalAccess[26] = new CDataSignalAccess( top.awprot );
      signalAccess[27] = new CDataSignalAccess( top.wValid );
      signalAccess[28] = new CDataSignalAccess( top.wReady );
      signalAccess[29] = new IDataSignalAccess( top.wdata );
      signalAccess[30] = new CDataSignalAccess( top.wstrb );
      signalAccess[31] = new CDataSignalAccess( top.wlast );
      signalAccess[32] = new CDataSignalAccess( top.rValid );
      signalAccess[33] = new CDataSignalAccess( top.rReady );
      signalAccess[34] = new IDataSignalAccess( top.rdata );
      signalAccess[35] = new CDataSignalAccess( top.rid );
      signalAccess[36] = new CDataSignalAccess( top.rresp );
      signalAccess[37] = new CDataSignalAccess( top.rlast );
      signalAccess[38] = new CDataSignalAccess( top.bValid );
      signalAccess[39] = new CDataSignalAccess( top.bReady );
      signalAccess[40] = new CDataSignalAccess( top.bid );
      signalAccess[41] = new CDataSignalAccess( top.bresp );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/AIE/./simWorkspace/TestAxi4WriteMaster/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/AIE/./simWorkspace/TestAxi4WriteMaster/") + name + ".dat").c_str());
      #endif
    }
