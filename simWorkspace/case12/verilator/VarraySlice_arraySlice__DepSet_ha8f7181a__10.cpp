...
VL_INLINE_OPT void VarraySlice_arraySlice___settle__TOP__arraySlice__298(VarraySlice_arraySlice* vlSelf) {
...
VL_INLINE_OPT void VarraySlice_arraySlice___settle__TOP__arraySlice__299(VarraySlice_arraySlice* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VarraySlice__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
