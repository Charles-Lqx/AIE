...
VL_MODULE(VPingPongBufferWithWriteOnlyMaster_PingPongBuffer) {
  ...
  public:
    ...
    static void _combo__TOP__PingPongBufferWithWriteOnlyMaster__pingPongBuffer_1__12(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
    static void _combo__TOP__PingPongBufferWithWriteOnlyMaster__pingPongBuffer_1__8(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _multiclk__TOP__PingPongBufferWithWriteOnlyMaster__pingPongBuffer_1__11(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
    static void _multiclk__TOP__PingPongBufferWithWriteOnlyMaster__pingPongBuffer_1__9(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
