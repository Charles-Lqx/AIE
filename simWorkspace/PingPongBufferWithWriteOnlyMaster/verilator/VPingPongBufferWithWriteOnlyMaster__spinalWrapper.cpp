...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.PingPongBufferWithWriteOnlyMaster->writeOnlyMater->axi4Interface_isInitialIterate );
      ...
      signalAccess[7] = new IDataSignalAccess( top.startAddr );
      signalAccess[8] = new IDataSignalAccess( top.offset );
      signalAccess[9] = new CDataSignalAccess( top.pathNumb );
      signalAccess[10] = new CDataSignalAccess( top.full_aw_valid );
      signalAccess[11] = new CDataSignalAccess( top.full_aw_ready );
      signalAccess[12] = new IDataSignalAccess( top.full_aw_payload_addr );
      signalAccess[13] = new CDataSignalAccess( top.full_aw_payload_region );
      signalAccess[14] = new CDataSignalAccess( top.full_aw_payload_len );
      signalAccess[15] = new CDataSignalAccess( top.full_aw_payload_size );
      signalAccess[16] = new CDataSignalAccess( top.full_aw_payload_burst );
      signalAccess[17] = new CDataSignalAccess( top.full_aw_payload_cache );
      signalAccess[18] = new CDataSignalAccess( top.full_aw_payload_qos );
      signalAccess[19] = new CDataSignalAccess( top.full_aw_payload_prot );
      signalAccess[20] = new CDataSignalAccess( top.full_w_valid );
      signalAccess[21] = new CDataSignalAccess( top.full_w_ready );
      signalAccess[22] = new IDataSignalAccess( top.full_w_payload_data );
      signalAccess[23] = new CDataSignalAccess( top.full_w_payload_strb );
      signalAccess[24] = new CDataSignalAccess( top.full_w_payload_last );
      signalAccess[25] = new CDataSignalAccess( top.full_b_valid );
      signalAccess[26] = new CDataSignalAccess( top.full_b_ready );
      signalAccess[27] = new CDataSignalAccess( top.full_b_payload_resp );
      signalAccess[28] = new CDataSignalAccess( top.aresetn );
      signalAccess[29] = new CDataSignalAccess( top.aclk );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/AIE/./simWorkspace/PingPongBufferWithWriteOnlyMaster/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/AIE/./simWorkspace/PingPongBufferWithWriteOnlyMaster/") + name + ".dat").c_str());
      #endif
    }
