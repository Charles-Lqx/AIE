...
public:
    ...
    uint32_t timeCheck;
    bool waveEnabled;
    VFifo2Axi4WriteOnlyMasterInterface top;
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.Fifo2Axi4WriteOnlyMasterInterface->axi4Interconnection->writeCounter );
      signalAccess[1] = new CDataSignalAccess( top.Fifo2Axi4WriteOnlyMasterInterface->axi4Interconnection->handshakeCounter );
      signalAccess[2] = new IDataSignalAccess( top.Fifo2Axi4WriteOnlyMasterInterface->axi4Interconnection->debugAddress );
      ...
      signalAccess[6] = new CDataSignalAccess( top.aw_valid );
      signalAccess[7] = new CDataSignalAccess( top.aw_ready );
      signalAccess[8] = new IDataSignalAccess( top.aw_payload_addr );
      signalAccess[9] = new CDataSignalAccess( top.aw_payload_region );
      signalAccess[10] = new CDataSignalAccess( top.aw_payload_len );
      signalAccess[11] = new CDataSignalAccess( top.aw_payload_size );
      signalAccess[12] = new CDataSignalAccess( top.aw_payload_burst );
      signalAccess[13] = new CDataSignalAccess( top.aw_payload_cache );
      signalAccess[14] = new CDataSignalAccess( top.aw_payload_qos );
      signalAccess[15] = new CDataSignalAccess( top.aw_payload_prot );
      signalAccess[16] = new CDataSignalAccess( top.w_valid );
      signalAccess[17] = new CDataSignalAccess( top.w_ready );
      signalAccess[18] = new IDataSignalAccess( top.w_payload_data );
      signalAccess[19] = new CDataSignalAccess( top.w_payload_strb );
      signalAccess[20] = new CDataSignalAccess( top.w_payload_last );
      signalAccess[21] = new CDataSignalAccess( top.b_valid );
      signalAccess[22] = new CDataSignalAccess( top.b_ready );
      signalAccess[23] = new CDataSignalAccess( top.b_payload_resp );
      signalAccess[24] = new CDataSignalAccess( top.resetn );
      signalAccess[25] = new CDataSignalAccess( top.clk );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/AIE/./simWorkspace/Fifo2Axi4WriteOnlyMasterInterface/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/AIE/./simWorkspace/Fifo2Axi4WriteOnlyMasterInterface/") + name + ".dat").c_str());
      #endif
    }
