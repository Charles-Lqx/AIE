...
public:
    ...
    uint32_t timeCheck;
    bool waveEnabled;
    VStream2Axi4WriteMasterInterfaceAddFifo top;
    ISignalAccess *signalAccess[39];
    #ifdef TRACE
	  VerilatedVcdC tfp;
	  #endif
    string name;
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new IDataSignalAccess( top.Stream2Axi4WriteMasterInterfaceAddFifo->axi4Interconnection->axi4Interface_address );
      signalAccess[1] = new CDataSignalAccess( top.s_axis_valid );
      signalAccess[2] = new CDataSignalAccess( top.s_axis_ready );
      signalAccess[3] = new IDataSignalAccess( top.s_axis_payload );
      signalAccess[4] = new CDataSignalAccess( top.m_axi_arvalid );
      signalAccess[5] = new CDataSignalAccess( top.m_axi_arready );
      signalAccess[6] = new IDataSignalAccess( top.m_axi_araddr );
      signalAccess[7] = new CDataSignalAccess( top.m_axi_arregion );
      signalAccess[8] = new CDataSignalAccess( top.m_axi_arlen );
      signalAccess[9] = new CDataSignalAccess( top.m_axi_arsize );
      signalAccess[10] = new CDataSignalAccess( top.m_axi_arburst );
      signalAccess[11] = new CDataSignalAccess( top.m_axi_arcache );
      signalAccess[12] = new CDataSignalAccess( top.m_axi_arqos );
      signalAccess[13] = new CDataSignalAccess( top.m_axi_arprot );
      signalAccess[14] = new CDataSignalAccess( top.m_axi_awvalid );
      signalAccess[15] = new CDataSignalAccess( top.m_axi_awready );
      signalAccess[16] = new IDataSignalAccess( top.m_axi_awaddr );
      signalAccess[17] = new CDataSignalAccess( top.m_axi_awregion );
      signalAccess[18] = new CDataSignalAccess( top.m_axi_awlen );
      signalAccess[19] = new CDataSignalAccess( top.m_axi_awsize );
      signalAccess[20] = new CDataSignalAccess( top.m_axi_awburst );
      signalAccess[21] = new CDataSignalAccess( top.m_axi_awcache );
      signalAccess[22] = new CDataSignalAccess( top.m_axi_awqos );
      signalAccess[23] = new CDataSignalAccess( top.m_axi_awprot );
      signalAccess[24] = new CDataSignalAccess( top.m_axi_wvalid );
      signalAccess[25] = new CDataSignalAccess( top.m_axi_wready );
      signalAccess[26] = new IDataSignalAccess( top.m_axi_wdata );
      signalAccess[27] = new CDataSignalAccess( top.m_axi_wstrb );
      signalAccess[28] = new CDataSignalAccess( top.m_axi_wlast );
      signalAccess[29] = new CDataSignalAccess( top.m_axi_rvalid );
      signalAccess[30] = new CDataSignalAccess( top.m_axi_rready );
      signalAccess[31] = new IDataSignalAccess( top.m_axi_rdata );
      signalAccess[32] = new CDataSignalAccess( top.m_axi_rresp );
      signalAccess[33] = new CDataSignalAccess( top.m_axi_rlast );
      signalAccess[34] = new CDataSignalAccess( top.m_axi_bvalid );
      signalAccess[35] = new CDataSignalAccess( top.m_axi_bready );
      signalAccess[36] = new CDataSignalAccess( top.m_axi_bresp );
      signalAccess[37] = new CDataSignalAccess( top.aresetn );
      signalAccess[38] = new CDataSignalAccess( top.aclk );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/AIE/./simWorkspace/Stream2Axi4WriteMasterInterfaceAddFifo/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/AIE/./simWorkspace/Stream2Axi4WriteMasterInterfaceAddFifo/") + name + ".dat").c_str());
      #endif
    }
