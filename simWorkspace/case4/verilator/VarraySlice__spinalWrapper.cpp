...
class Wrapper_4;
thread_local Wrapper_4 *simHandle4;
...
public:
    ...
    Wrapper_4(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/AIE/./simWorkspace/case4/") + name + ".fst").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_4(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/AIE/./simWorkspace/case4/") + name + ".dat").c_str());
      #endif
    }
...
JNIEXPORT Wrapper_4 * API JNICALL Java_wrapper_1verilator_VerilatorNative_newHandle_14
  (JNIEnv * env, jobject obj, jstring name, jint seedValue){
    ...
    Wrapper_4 *handle = new Wrapper_4(ch);
    env->ReleaseStringUTFChars(name, ch);
    return handle;
}

JNIEXPORT jboolean API JNICALL Java_wrapper_1verilator_VerilatorNative_eval_14
  (JNIEnv *, jobject, Wrapper_4 *handle){
   handle->top.eval();
   return Verilated::gotFinish();
}


JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_sleep_14
  (JNIEnv *, jobject, Wrapper_4 *handle, uint64_t cycles){
  #ifdef TRACE
...
JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64_14
  (JNIEnv *, jobject, Wrapper_4 *handle, int id){
  return handle->signalAccess[id]->getU64();
}

JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64mem_14
  (JNIEnv *, jobject, Wrapper_4 *handle, int id, uint64_t index){
  return handle->signalAccess[id]->getU64_mem(index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64_14
  (JNIEnv *, jobject, Wrapper_4 *handle, int id, uint64_t value){
  handle->signalAccess[id]->setU64(value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64mem_14
  (JNIEnv *, jobject, Wrapper_4 *handle, int id, uint64_t value, uint64_t index){
  handle->signalAccess[id]->setU64_mem(value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_deleteHandle_14
  (JNIEnv *, jobject, Wrapper_4 * handle){
  delete handle;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8_14
  (JNIEnv * env, jobject obj, Wrapper_4 * handle, jint id, jbyteArray value){
  handle->signalAccess[id]->getAU8(env, value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8mem_14
  (JNIEnv * env, jobject obj, Wrapper_4 * handle, jint id, jbyteArray value, uint64_t index){
  handle->signalAccess[id]->getAU8_mem(env, value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8_14
  (JNIEnv * env, jobject obj, Wrapper_4 * handle, jint id, jbyteArray value, jint length){
  handle->signalAccess[id]->setAU8(env, value, length);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8mem_14
  (JNIEnv * env, jobject obj, Wrapper_4 * handle, jint id, jbyteArray value, jint length, uint64_t index){
  handle->signalAccess[id]->setAU8_mem(env, value, length, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_enableWave_14
  (JNIEnv *, jobject, Wrapper_4 * handle){
  handle->waveEnabled = true;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_disableWave_14
  (JNIEnv *, jobject, Wrapper_4 * handle){
