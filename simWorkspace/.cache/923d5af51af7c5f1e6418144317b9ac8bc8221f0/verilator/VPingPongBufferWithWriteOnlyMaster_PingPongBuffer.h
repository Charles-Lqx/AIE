...
VL_MODULE(VPingPongBufferWithWriteOnlyMaster_PingPongBuffer) {
  public:
    ...
    VL_SIG8(__PVT__when_PingPongBuffer_l214,0,0);
    VL_SIG8(__PVT__readyForNextTransfer,0,0);
    VL_SIG8(__PVT__when_PingPongBuffer_l223,0,0);
    VL_SIG8(__PVT__when_PingPongBuffer_l228,0,0);
    VL_SIG8(__PVT__pingPongBufferStateMachine_stateReg,1,0);
    VL_SIG8(__PVT__pingPongBufferStateMachine_stateNext,1,0);
    VL_SIG8(__PVT__when_PingPongBuffer_l147,0,0);
    VL_SIG8(__PVT__when_PingPongBuffer_l154,0,0);
    VL_SIG8(__PVT__when_PingPongBuffer_l168,0,0);
