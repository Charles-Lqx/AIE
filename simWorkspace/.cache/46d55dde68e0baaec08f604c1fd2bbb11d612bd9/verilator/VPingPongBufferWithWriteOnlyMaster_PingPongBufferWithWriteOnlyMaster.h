...
VL_MODULE(VPingPongBufferWithWriteOnlyMaster_PingPongBufferWithWriteOnlyMaster) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__pingPongBuffer_1__DOT__when_PingPongBuffer_l223;
        CData/*0:0*/ __PVT__pingPongBuffer_1__DOT__when_PingPongBuffer_l228;
        ...
        CData/*0:0*/ __PVT__pingPongBuffer_1__DOT__when_PingPongBuffer_l143;
        CData/*0:0*/ __PVT__pingPongBuffer_1__DOT__when_PingPongBuffer_l150;
    };
    struct {
        CData/*0:0*/ __PVT__pingPongBuffer_1__DOT__when_PingPongBuffer_l163;
