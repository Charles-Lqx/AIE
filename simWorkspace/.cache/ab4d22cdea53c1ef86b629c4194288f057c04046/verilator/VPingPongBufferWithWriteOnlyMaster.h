...
VL_MODULE(VPingPongBufferWithWriteOnlyMaster) {
  public:
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT__streamFifo_3_io_pop_valid_regNext,0,0);
    ...
    VL_SIG(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT__streamFifo_3_io_pop_payload_regNext,31,0);
  ...
  public:
    ...
    static void _combo__TOP__14(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
    static void _combo__TOP__17(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
  ...
  public:
    ...
    static void _multiclk__TOP__13(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
    static void _multiclk__TOP__15(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
    static void _multiclk__TOP__16(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
    ...
    static void traceChgThis__17(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    ...
    static void traceFullThis__18(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
