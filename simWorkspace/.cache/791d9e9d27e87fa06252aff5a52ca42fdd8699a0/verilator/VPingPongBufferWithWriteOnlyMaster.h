...
VL_MODULE(VPingPongBufferWithWriteOnlyMaster) {
  public:
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__outputStartSignalReg,0,0);
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__startReceiveSignal_regNext,0,0);
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__validA,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__validB,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l208,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l212,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__readyForOutputStartSignal,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l223,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l227,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__isReadBufferA_regNext,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l233,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__isReadBufferA_regNext_1,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l234,0,0);
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l143,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l150,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l163,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l187,0,0);
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT___zz_when_Axi4WriteOnlyMaster_l97,0,0);
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT__when_Axi4WriteOnlyMaster_l97,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT__axi4Interface_newBurst,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT__axi4Interface_full_b_fire_1,0,0);
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT__when_Axi4WriteOnlyMaster_l160,0,0);
    ...
    VL_SIG16(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT___zz_when_Axi4WriteOnlyMaster_l97_1,8,0);
    VL_SIG16(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT___zz_when_Axi4WriteOnlyMaster_l97_2,8,0);
    ...
    VL_SIG(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__offsetA,31,0);
    VL_SIG(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__offsetB,31,0);
    VL_SIG(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__outputDataOffsetReg,31,0);
    ...
    VL_SIG(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT__startOffsetReg,31,0);
    ...
    VL_SIG8(__Vdly__PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__outputStartSignalReg,0,0);
    VL_SIG8(__Vdly__PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__readyForOutputStartSignal,0,0);
    ...
    VL_SIG8(__VinpClk__TOP__PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__outputStartSignalReg,0,0);
    ...
    VL_SIG8(__Vclklast__TOP____VinpClk__TOP__PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__outputStartSignalReg,0,0);
    ...
    VL_SIG8(__Vchglast__TOP__PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__outputStartSignalReg,0,0);
    ...
    VL_SIG(__Vdly__PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__offsetA,31,0);
    VL_SIG(__Vdly__PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__offsetB,31,0);
  ...
  public:
    ...
    static void _multiclk__TOP__10(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
    static void _multiclk__TOP__12(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
    static void _multiclk__TOP__14(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
    static void _sequent__TOP__11(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
    ...
    static void traceChgThis__18(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
