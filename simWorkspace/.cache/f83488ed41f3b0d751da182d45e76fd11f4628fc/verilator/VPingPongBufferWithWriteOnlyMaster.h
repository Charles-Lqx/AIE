...
VL_MODULE(VPingPongBufferWithWriteOnlyMaster) {
  public:
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l213,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l225,0,0);
