...
#ifndef VERILATED_VSTREAM2AXI4WRITEONLYMASTERINTERFACEADDFIFO_STREAM2AXI4WRITEONLYMASTERINTERFACE_H_
#define VERILATED_VSTREAM2AXI4WRITEONLYMASTERINTERFACEADDFIFO_STREAM2AXI4WRITEONLYMASTERINTERFACE_H_  // guard
...
VL_MODULE(VStream2Axi4WriteOnlyMasterInterfaceAddFifo_Stream2Axi4WriteOnlyMasterInterface) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__when_Axi4WriteOnlyMaster_l159;
        CData/*0:0*/ __PVT__when_Axi4WriteOnlyMaster_l164;
        CData/*0:0*/ __PVT__when_Axi4WriteOnlyMaster_l187;
    ...
    struct {
        ...
        SData/*8:0*/ __PVT___zz_when_Axi4WriteOnlyMaster_l105_1;
        SData/*8:0*/ __PVT___zz_when_Axi4WriteOnlyMaster_l105_2;
        ...
        VlUnpacked<IData/*31:0*/, 256> __PVT__streamFifo_2__DOT__logic_ram;
    };
    ...
    // CONSTRUCTORS
    VStream2Axi4WriteOnlyMasterInterfaceAddFifo_Stream2Axi4WriteOnlyMasterInterface(const char* name);
    ~VStream2Axi4WriteOnlyMasterInterfaceAddFifo_Stream2Axi4WriteOnlyMasterInterface();
    VL_UNCOPYABLE(VStream2Axi4WriteOnlyMasterInterfaceAddFifo_Stream2Axi4WriteOnlyMasterInterface);
