...
VL_MODULE(VPingPongBufferWithWriteOnlyMaster_PingPongBuffer) {
  public:
    ...
    VL_SIG8(__PVT__inCounter_valueNext,6,0);
    VL_SIG8(__PVT__inCounter_value,6,0);
    VL_SIG8(__PVT__outCounter_willIncrement,0,0);
    VL_SIG8(__PVT__outCounter_willClear,0,0);
    VL_SIG8(__PVT__outCounter_valueNext,6,0);
    VL_SIG8(__PVT__outCounter_value,6,0);
    ...
    VL_SIG8(__PVT__bufferFifoA__DOT__logic_pushPtr_valueNext,6,0);
    VL_SIG8(__PVT__bufferFifoA__DOT__logic_pushPtr_value,6,0);
    VL_SIG8(__PVT__bufferFifoA__DOT__logic_popPtr_willIncrement,0,0);
    VL_SIG8(__PVT__bufferFifoA__DOT__logic_popPtr_valueNext,6,0);
    VL_SIG8(__PVT__bufferFifoA__DOT__logic_popPtr_value,6,0);
    ...
    VL_SIG8(__PVT__bufferFifoB__DOT__logic_pushPtr_valueNext,6,0);
    VL_SIG8(__PVT__bufferFifoB__DOT__logic_pushPtr_value,6,0);
    VL_SIG8(__PVT__bufferFifoB__DOT__logic_popPtr_willIncrement,0,0);
    VL_SIG8(__PVT__bufferFifoB__DOT__logic_popPtr_valueNext,6,0);
    VL_SIG8(__PVT__bufferFifoB__DOT__logic_popPtr_value,6,0);
    ...
    VL_SIG(__PVT__bufferFifoA__DOT__logic_ram[128],31,0);
    VL_SIG(__PVT__bufferFifoB__DOT__logic_ram[128],31,0);
    ...
    VL_SIG8(__Vdly__bufferFifoA__DOT__logic_pushPtr_value,6,0);
    VL_SIG8(__Vdly__bufferFifoB__DOT__logic_pushPtr_value,6,0);
