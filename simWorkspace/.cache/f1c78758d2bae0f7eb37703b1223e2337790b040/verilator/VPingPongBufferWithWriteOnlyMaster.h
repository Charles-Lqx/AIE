...
VL_MODULE(VPingPongBufferWithWriteOnlyMaster) {
  public:
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT__streamFifo_3_io_pop_rValid,0,0);
    ...
    VL_SIG(PingPongBufferWithWriteOnlyMaster__DOT__writeOnlyMater__DOT__streamFifo_3_io_pop_rData,31,0);
  ...
  public:
    ...
    static void _combo__TOP__16(VPingPongBufferWithWriteOnlyMaster__Syms* __restrict vlSymsp);
