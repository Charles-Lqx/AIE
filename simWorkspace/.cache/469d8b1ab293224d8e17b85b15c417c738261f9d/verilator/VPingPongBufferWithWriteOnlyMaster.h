...
VL_MODULE(VPingPongBufferWithWriteOnlyMaster) {
  public:
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT___zz_holdStartSignal,7,0);
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__holdStartSignal,0,0);
    ...
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l146,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l159,0,0);
    VL_SIG8(PingPongBufferWithWriteOnlyMaster__DOT__pingPongBuffer_1__DOT__when_PingPongBuffer_l183,0,0);
