...
VL_MODULE(VPingPongBufferWithWriteOnlyMaster_PingPongBufferWithWriteOnlyMaster) {
  public:
    ...
    VL_SIG8(__PVT__writeOnlyMater__DOT__streamFifo_3_io_pop_rValid,0,0);
    ...
    VL_SIG16(__PVT__writeOnlyMater__DOT___zz_m_axi_wlast_1,8,0);
    VL_SIG16(__PVT__writeOnlyMater__DOT___zz_m_axi_wlast_2,8,0);
    VL_SIG16(__PVT__writeOnlyMater__DOT___zz_when_Axi4WriteOnlyMaster_l97_1,8,0);
    VL_SIG16(__PVT__writeOnlyMater__DOT___zz_when_Axi4WriteOnlyMaster_l97_2,8,0);
    ...
    VL_SIG(__PVT__writeOnlyMater__DOT__streamFifo_3_io_pop_rData,31,0);
