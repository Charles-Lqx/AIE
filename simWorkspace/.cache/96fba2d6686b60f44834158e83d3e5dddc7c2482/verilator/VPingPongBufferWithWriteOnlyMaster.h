...
VL_MODULE(VPingPongBufferWithWriteOnlyMaster) {
  public:
    ...
    VL_SIG8(__VinpClk__TOP__PingPongBufferWithWriteOnlyMaster__pingPongBuffer_1____PVT__outputStartSignalState,0,0);
    ...
    VL_SIG8(__Vclklast__TOP____VinpClk__TOP__PingPongBufferWithWriteOnlyMaster__pingPongBuffer_1____PVT__outputStartSignalState,0,0);
    ...
    VL_SIG8(__Vchglast__TOP__PingPongBufferWithWriteOnlyMaster__pingPongBuffer_1__outputStartSignalState,0,0);
