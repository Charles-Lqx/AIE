...
VL_ATTR_COLD void VarraySlice_arraySlice___settle__TOP__arraySlice__275(VarraySlice_arraySlice* vlSelf) {
...
VL_ATTR_COLD void VarraySlice_arraySlice___settle__TOP__arraySlice__276(VarraySlice_arraySlice* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VarraySlice__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
