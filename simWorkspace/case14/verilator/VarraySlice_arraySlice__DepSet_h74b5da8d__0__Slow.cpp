...
VL_ATTR_COLD void VarraySlice_arraySlice___initial__TOP__arraySlice__100(VarraySlice_arraySlice* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VarraySlice__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      VarraySlice_arraySlice___initial__TOP__arraySlice__100\n"); );
    // Body
...
VL_ATTR_COLD void VarraySlice_arraySlice___settle__TOP__arraySlice__103(VarraySlice_arraySlice* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VarraySlice__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
