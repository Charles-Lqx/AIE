...
#ifndef _VTestFifo2Axi4WriteMaster_TestAxi4WriteMaster_H_
#define _VTestFifo2Axi4WriteMaster_TestAxi4WriteMaster_H_
...
VL_MODULE(VTestFifo2Axi4WriteMaster_TestAxi4WriteMaster) {
  public:
    ...
    VL_SIG8(__PVT___zz_when_Axi4WriteMaster_l62,0,0);
    VL_SIG8(__PVT___zz_when_Axi4WriteMaster_l54,0,0);
    VL_SIG8(__PVT___zz_3,0,0);
    VL_SIG8(__PVT__axi4Interface_fifo_fire,0,0);
    VL_SIG8(__PVT__axi4Interface_controlAwValidWithWChannel,0,0);
    VL_SIG16(__PVT___zz_wdata_1,8,0);
    VL_SIG16(__PVT___zz_wdata_2,8,0);
    VL_SIG16(__PVT___zz_when_Axi4WriteMaster_l54_1,8,0);
    VL_SIG16(__PVT___zz_when_Axi4WriteMaster_l54_2,8,0);
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VTestFifo2Axi4WriteMaster_TestAxi4WriteMaster& operator= (const VTestFifo2Axi4WriteMaster_TestAxi4WriteMaster&);  ///< Copying not allowed
    VTestFifo2Axi4WriteMaster_TestAxi4WriteMaster(const VTestFifo2Axi4WriteMaster_TestAxi4WriteMaster&);  ///< Copying not allowed
  public:
    VTestFifo2Axi4WriteMaster_TestAxi4WriteMaster(const char* name="TOP");
    ...
    static void _combo__TOP__TestFifo2Axi4WriteMaster__axi4Interconnection__14(VTestFifo2Axi4WriteMaster__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset();
  public:
    static void _sequent__TOP__TestFifo2Axi4WriteMaster__axi4Interconnection__10(VTestFifo2Axi4WriteMaster__Syms* __restrict vlSymsp);
    static void _sequent__TOP__TestFifo2Axi4WriteMaster__axi4Interconnection__11(VTestFifo2Axi4WriteMaster__Syms* __restrict vlSymsp);
    static void _sequent__TOP__TestFifo2Axi4WriteMaster__axi4Interconnection__12(VTestFifo2Axi4WriteMaster__Syms* __restrict vlSymsp);
    static void _sequent__TOP__TestFifo2Axi4WriteMaster__axi4Interconnection__13(VTestFifo2Axi4WriteMaster__Syms* __restrict vlSymsp);
    static void _sequent__TOP__TestFifo2Axi4WriteMaster__axi4Interconnection__8(VTestFifo2Axi4WriteMaster__Syms* __restrict vlSymsp);
    static void _settle__TOP__TestFifo2Axi4WriteMaster__axi4Interconnection__1(VTestFifo2Axi4WriteMaster__Syms* __restrict vlSymsp);
    static void _settle__TOP__TestFifo2Axi4WriteMaster__axi4Interconnection__2(VTestFifo2Axi4WriteMaster__Syms* __restrict vlSymsp);
    static void _settle__TOP__TestFifo2Axi4WriteMaster__axi4Interconnection__3(VTestFifo2Axi4WriteMaster__Syms* __restrict vlSymsp);
