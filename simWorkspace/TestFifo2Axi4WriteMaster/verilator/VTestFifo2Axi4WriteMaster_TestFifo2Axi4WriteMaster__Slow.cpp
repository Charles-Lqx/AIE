...
VL_CTOR_IMP(VTestFifo2Axi4WriteMaster_TestFifo2Axi4WriteMaster) {
    VL_CELL (axi4Interconnection, VTestFifo2Axi4WriteMaster_TestAxi4WriteMaster);
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void VTestFifo2Axi4WriteMaster_TestFifo2Axi4WriteMaster::__Vconfigure(VTestFifo2Axi4WriteMaster__Syms* vlSymsp, bool first) {
    if (0 && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
}

VTestFifo2Axi4WriteMaster_TestFifo2Axi4WriteMaster::~VTestFifo2Axi4WriteMaster_TestFifo2Axi4WriteMaster() {
}

//--------------------
// Internal Methods

void VTestFifo2Axi4WriteMaster_TestFifo2Axi4WriteMaster::_settle__TOP__TestFifo2Axi4WriteMaster__1(VTestFifo2Axi4WriteMaster__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VTestFifo2Axi4WriteMaster_TestFifo2Axi4WriteMaster::_settle__TOP__TestFifo2Axi4WriteMaster__1\n"); );
...
void VTestFifo2Axi4WriteMaster_TestFifo2Axi4WriteMaster::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VTestFifo2Axi4WriteMaster_TestFifo2Axi4WriteMaster::_ctor_var_reset\n"); );
    // Body
