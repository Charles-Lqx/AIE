...
public:
    ...
    uint32_t timeCheck;
    bool waveEnabled;
    VTestFifo2Axi4WriteOnlyMaster top;
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.TestFifo2Axi4WriteOnlyMaster->axi4Interconnection->writeCounter );
      signalAccess[1] = new CDataSignalAccess( top.TestFifo2Axi4WriteOnlyMaster->axi4Interconnection->handshakeCounter );
      signalAccess[2] = new IDataSignalAccess( top.TestFifo2Axi4WriteOnlyMaster->axi4Interconnection->debugAddress );
      signalAccess[3] = new CDataSignalAccess( top.fifoInterface_valid );
      signalAccess[4] = new CDataSignalAccess( top.fifoInterface_ready );
      signalAccess[5] = new IDataSignalAccess( top.fifoInterface_payload );
      signalAccess[6] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_valid );
      signalAccess[7] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_ready );
      signalAccess[8] = new IDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_payload_addr );
      signalAccess[9] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_payload_id );
      signalAccess[10] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_payload_region );
      signalAccess[11] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_payload_len );
      signalAccess[12] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_payload_size );
      signalAccess[13] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_payload_burst );
      signalAccess[14] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_payload_lock );
      signalAccess[15] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_payload_cache );
      signalAccess[16] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_payload_qos );
      signalAccess[17] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_aw_payload_prot );
      signalAccess[18] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_w_valid );
      signalAccess[19] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_w_ready );
      signalAccess[20] = new IDataSignalAccess( top.axi4WriteOnlyMasterInterface_w_payload_data );
      signalAccess[21] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_w_payload_strb );
      signalAccess[22] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_w_payload_last );
      signalAccess[23] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_b_valid );
      signalAccess[24] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_b_ready );
      signalAccess[25] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_b_payload_id );
      signalAccess[26] = new CDataSignalAccess( top.axi4WriteOnlyMasterInterface_b_payload_resp );
      signalAccess[27] = new CDataSignalAccess( top.resetn );
      signalAccess[28] = new CDataSignalAccess( top.clk );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/AIE/./simWorkspace/TestFifo2Axi4WriteOnlyMaster/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/AIE/./simWorkspace/TestFifo2Axi4WriteOnlyMaster/") + name + ".dat").c_str());
      #endif
    }
