...
public:
    ...
    uint32_t timeCheck;
    bool waveEnabled;
    VFifo2Axi4WriteMasterInterface top;
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new IDataSignalAccess( top.Fifo2Axi4WriteMasterInterface->axi4Interconnection->axi4Interface_address );
      ...
      signalAccess[4] = new CDataSignalAccess( top.ar_valid );
      signalAccess[5] = new CDataSignalAccess( top.ar_ready );
      signalAccess[6] = new IDataSignalAccess( top.ar_payload_addr );
      signalAccess[7] = new CDataSignalAccess( top.ar_payload_region );
      signalAccess[8] = new CDataSignalAccess( top.ar_payload_len );
      signalAccess[9] = new CDataSignalAccess( top.ar_payload_size );
      signalAccess[10] = new CDataSignalAccess( top.ar_payload_burst );
      signalAccess[11] = new CDataSignalAccess( top.ar_payload_cache );
      signalAccess[12] = new CDataSignalAccess( top.ar_payload_qos );
      signalAccess[13] = new CDataSignalAccess( top.ar_payload_prot );
      signalAccess[14] = new CDataSignalAccess( top.aw_valid );
      signalAccess[15] = new CDataSignalAccess( top.aw_ready );
      signalAccess[16] = new IDataSignalAccess( top.aw_payload_addr );
      signalAccess[17] = new CDataSignalAccess( top.aw_payload_region );
      signalAccess[18] = new CDataSignalAccess( top.aw_payload_len );
      signalAccess[19] = new CDataSignalAccess( top.aw_payload_size );
      signalAccess[20] = new CDataSignalAccess( top.aw_payload_burst );
      signalAccess[21] = new CDataSignalAccess( top.aw_payload_cache );
      signalAccess[22] = new CDataSignalAccess( top.aw_payload_qos );
      signalAccess[23] = new CDataSignalAccess( top.aw_payload_prot );
      signalAccess[24] = new CDataSignalAccess( top.w_valid );
      signalAccess[25] = new CDataSignalAccess( top.w_ready );
      signalAccess[26] = new IDataSignalAccess( top.w_payload_data );
      signalAccess[27] = new CDataSignalAccess( top.w_payload_strb );
      signalAccess[28] = new CDataSignalAccess( top.w_payload_last );
      signalAccess[29] = new CDataSignalAccess( top.r_valid );
      signalAccess[30] = new CDataSignalAccess( top.r_ready );
      signalAccess[31] = new IDataSignalAccess( top.r_payload_data );
      signalAccess[32] = new CDataSignalAccess( top.r_payload_resp );
      signalAccess[33] = new CDataSignalAccess( top.r_payload_last );
      signalAccess[34] = new CDataSignalAccess( top.b_valid );
      signalAccess[35] = new CDataSignalAccess( top.b_ready );
      signalAccess[36] = new CDataSignalAccess( top.b_payload_resp );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/AIE/./simWorkspace/Fifo2Axi4WriteMasterInterface/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/AIE/./simWorkspace/Fifo2Axi4WriteMasterInterface/") + name + ".dat").c_str());
      #endif
    }
