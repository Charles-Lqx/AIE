...
VL_CTOR_IMP(VFifo2Axi4WriteMasterInterface_Fifo2Axi4WriteMasterInterface) {
    VL_CELL (axi4Interconnection, VFifo2Axi4WriteMasterInterface_Axi4WriteMasterInterface);
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void VFifo2Axi4WriteMasterInterface_Fifo2Axi4WriteMasterInterface::__Vconfigure(VFifo2Axi4WriteMasterInterface__Syms* vlSymsp, bool first) {
    if (0 && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
}

VFifo2Axi4WriteMasterInterface_Fifo2Axi4WriteMasterInterface::~VFifo2Axi4WriteMasterInterface_Fifo2Axi4WriteMasterInterface() {
}

//--------------------
// Internal Methods

void VFifo2Axi4WriteMasterInterface_Fifo2Axi4WriteMasterInterface::_settle__TOP__Fifo2Axi4WriteMasterInterface__1(VFifo2Axi4WriteMasterInterface__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VFifo2Axi4WriteMasterInterface_Fifo2Axi4WriteMasterInterface::_settle__TOP__Fifo2Axi4WriteMasterInterface__1\n"); );
...
void VFifo2Axi4WriteMasterInterface_Fifo2Axi4WriteMasterInterface::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+      VFifo2Axi4WriteMasterInterface_Fifo2Axi4WriteMasterInterface::_ctor_var_reset\n"); );
    // Body
