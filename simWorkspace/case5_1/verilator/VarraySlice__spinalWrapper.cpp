...
class Wrapper_6;
thread_local Wrapper_6 *simHandle6;
...
public:
    ...
    Wrapper_6(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/AIE/./simWorkspace/case5_1/") + name + ".fst").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_6(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/AIE/./simWorkspace/case5_1/") + name + ".dat").c_str());
      #endif
    }
...
JNIEXPORT Wrapper_6 * API JNICALL Java_wrapper_1verilator_VerilatorNative_newHandle_16
  (JNIEnv * env, jobject obj, jstring name, jint seedValue){
    ...
    Wrapper_6 *handle = new Wrapper_6(ch);
    env->ReleaseStringUTFChars(name, ch);
    return handle;
}

JNIEXPORT jboolean API JNICALL Java_wrapper_1verilator_VerilatorNative_eval_16
  (JNIEnv *, jobject, Wrapper_6 *handle){
   handle->top.eval();
   return Verilated::gotFinish();
}


JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_sleep_16
  (JNIEnv *, jobject, Wrapper_6 *handle, uint64_t cycles){
  #ifdef TRACE
...
JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64_16
  (JNIEnv *, jobject, Wrapper_6 *handle, int id){
  return handle->signalAccess[id]->getU64();
}

JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64mem_16
  (JNIEnv *, jobject, Wrapper_6 *handle, int id, uint64_t index){
  return handle->signalAccess[id]->getU64_mem(index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64_16
  (JNIEnv *, jobject, Wrapper_6 *handle, int id, uint64_t value){
  handle->signalAccess[id]->setU64(value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64mem_16
  (JNIEnv *, jobject, Wrapper_6 *handle, int id, uint64_t value, uint64_t index){
  handle->signalAccess[id]->setU64_mem(value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_deleteHandle_16
  (JNIEnv *, jobject, Wrapper_6 * handle){
  delete handle;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8_16
  (JNIEnv * env, jobject obj, Wrapper_6 * handle, jint id, jbyteArray value){
  handle->signalAccess[id]->getAU8(env, value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8mem_16
  (JNIEnv * env, jobject obj, Wrapper_6 * handle, jint id, jbyteArray value, uint64_t index){
  handle->signalAccess[id]->getAU8_mem(env, value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8_16
  (JNIEnv * env, jobject obj, Wrapper_6 * handle, jint id, jbyteArray value, jint length){
  handle->signalAccess[id]->setAU8(env, value, length);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8mem_16
  (JNIEnv * env, jobject obj, Wrapper_6 * handle, jint id, jbyteArray value, jint length, uint64_t index){
  handle->signalAccess[id]->setAU8_mem(env, value, length, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_enableWave_16
  (JNIEnv *, jobject, Wrapper_6 * handle){
  handle->waveEnabled = true;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_disableWave_16
  (JNIEnv *, jobject, Wrapper_6 * handle){
